...
//     } else document.getElementById('button-1').innerHTML = '&#9660'
//     if (div.style.display == "none") {
//         document.getElementById("button-1").innerHTML = '&#9650;'
//     } else document.getElementById('button-2').innerHTML = '&#9660'
// }
...
$(document).ready(function() {
    ...
    // Get details and data files
    let details_url = './data/_details.json';
    //let data_url = './data/_data.json';
    let data_url = 'https://results.enr.clarityelections.com//CO/105975/276916/json/sum.json'; //2020
    //let data_url = 'https://results.enr.clarityelections.com/CO//115903/316199/json/sum.json'; //2022
    //let data_url = 'https://results.enr.clarityelections.com/CO/122598/348601/json/sum.json'; //2024
